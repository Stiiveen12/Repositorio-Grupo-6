...
import com.grupo39.misiontic2022.ciclo4.Almacenes_team_6.repository.ProductoRepository;
	...
	public ResponseEntity<Producto> createProducto(@RequestBody Producto product) {
		try {
			Producto _producto = productoRepository.save(
					new Producto(product.getIvacompra(), product.getNitproveedor(), product.getNombreproducto(),
